      ...
      <div className="col-10 col-lg-5">
        <form onSubmit={submitHandler} className="shadow-lg" encType="multipart/form-data">
          ...
          <div className="form-group">
            ...
            <input name="name" onChange={onChange} id="name_field" className="form-control" value={useData.name} />
          </div>
          ...
          <button disabled={loading} id="register_button" type="submit" className="btn btn-block py-3">
            REGISTER
          </button>
        </form>
      </div>
